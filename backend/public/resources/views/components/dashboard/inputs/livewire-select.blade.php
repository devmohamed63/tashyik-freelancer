<div>
    ...
    <div class="relative">
        <select {{ $attributes->merge(['class' => 'bg-transparent border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-brand-500 focus:border-brand-500 block w-full p-3 dark:bg-gray-900 dark:border-gray-700 dark:placeholder-gray-400 dark:text-white dark:focus:ring-brand-500 dark:focus:border-brand-500 shadow-theme-xs']) }}>
            {{ $slot }}
        </select>
