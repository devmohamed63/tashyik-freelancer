...
<body
    x-data="{ page: '{{ $page }}', 'loaded': true, 'stickyMenu': false, 'darkMode': false, 'sidebarToggle': false, 'scrollTop': false, 'dir': '{{ $dir }}' }"
    x-init="darkMode = 'darkMode' in localStorage ? JSON.parse(localStorage.getItem('darkMode')) : window.matchMedia('(prefers-color-scheme: dark)').matches;
    ...
    <div class="relative p-6 bg-white z-1 dark:bg-gray-900 sm:p-0">
        <div class="relative flex flex-col justify-center w-full h-screen dark:bg-gray-900 sm:p-0 lg:flex-row">
            ...
            <div class="flex flex-col flex-1 w-full lg:w-1/2">
                <div class="w-full max-w-md pt-10 mx-auto flex items-center justify-between">
                    <a href="{{ route('home') }}"
                        ...
                        <svg class="stroke-current rtl:rotate-180" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20"
                            fill="none">
            ...
            <div class="relative items-center hidden w-full h-full bg-brand-950 dark:bg-white/5 lg:grid lg:w-1/2">
                <div class="flex items-center justify-center z-1">
                    ...
                    <div class="flex flex-col items-center max-w-xs">
                        <a href="{{ route('home') }}" class="block mb-4 dark">
                            <x-app-logo class="max-h-14" />
                        </a>
            ...
            <!-- Toggler -->
            <div class="fixed z-50 hidden bottom-6 end-6 sm:block">
                <button
